...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="css/dataCaffetracker.css">
  <!-- Library AOS -->
  ...
  <!-- Javascript -->
  <script>
    var userId = <?php echo json_encode($id_konsumen); ?>;
  </script>
      ...
      <div class="card-user">
        <div class="content-card">
          ...
          <div class="data-caffetracker">
            ...
            <a href="dataRiwayatKonsumsi.php?id=<?php echo $id_konsumen; ?>">Lihat riwayat konsumsi</a>
            <div class="summary">
              <h2>DIAGRAM HARIAN KONSUMSI KOPI</h2>
              <div class="diagram">
                <div class="chartKafein">
                  <canvas id="chartKafein"></canvas>
                </div>
                <div class="chartGlukosa">
                  <canvas id="chartGlukosa"></canvas>
                </div>
              </div>
              <h2>GRAFIK MINGGUAN KONSUMSI KOPI</h2>
              <div class="chart">
