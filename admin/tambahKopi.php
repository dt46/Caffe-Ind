...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/tambahKopi.css">
    <!-- Library AOS -->
                    ...
                    <div class="form">
                        ...
                        <form action="saveKopi.php" method="get">
                            ...
                            <div class="input">
                                ...
                                <input type="text" placeholder="Masukkan nama menu kopi" name="nama" id="nama" required>
                            ...
                            <div class="input">
                                ...
                                <input type="number" placeholder="Masukkan takaran kopi" name="kopi" id="kopi" required>
                            </div>
                            <div class="input">
                                <h4>Takaran Gula (ml)</h4>
                                <div class="detail">
                                    <p>Less Sugar</p>
                                    <input type="number" placeholder="Masukkan Takaran Less Sugar" name="less_sugar" id="less_sugar" required>
                                </div>
                                <div class="detail">
                                    <p>Normal Sugar</p>
                                    <input type="number" placeholder="Masukkan Takaran Normal Sugar" name="normal_sugar" id="normal_sugar" required>
                                </div>
                                <div class="detail">
                                    <p>Extra Sugar</p>
                                    <input type="number" placeholder="Masukkan Takaran Extra Sugar" name="extra_sugar" id="extra_sugar" required>
                                </div>
                            </div>
                            ...
                            <button type="submit" id="button-submit-kopi">Tambah</button>
                        </form>
                    </div>
                </div>
            </div>
