        ...
        <div class="content-card">
          ...
          echo '<div class="data-image">
                  ...
                  <div class="data-user">
                    ...
                    <div class="data">
                      <h4>Tinggi Badan</h4>
                      <p>' . $data[0]->tinggi_badan . ' cm</p>
                    </div>
                    <div class="data">
                      <h4>Berat Badan</h4>
                      <p>' . $data[0]->berat_badan . ' kg</p>
                    </div>';
                    $jenisKelamin = $data[0]->jenis_kelamin;
                    if ($jenisKelamin === 'Wanita') {
                      // Jjika jenis kelamin Wanita maka akan ditampilkan data status kehamilan
                      echo '<div class="data">
                              <h4>Status Kehamilan</h4>
                              <p>' . $data[0]->status_kehamilan . '</p>
                            </div>';
                    };                      
                    echo '<div class="data" id="statusKehamilan">
                      <h4>Status Kehamilan</h4>
                      <ul>';
                        $riwayat_penyakit = $data[0]->riwayat_penyakit;
