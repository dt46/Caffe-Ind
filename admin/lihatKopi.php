...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/lihatKopi.css">
    <!-- Library AOS -->
        ...
        <div class="container" data-aos="zoom-in-up">
            <div class="card-kopi">
                ...
                echo '<div class="content-card">
                            ...
                            <div class="nama-kopi">      
                                <h2>' . $data[0]->nama . '</h2>                                
                                <img src="' . $data[0]->foto . '" alt="" class="picture-kopi">
                            </div>
                            <div class="data-kopi">
                              <div class="data">
                                  <h4>Detail Kopi</h4>
                                  <div class="content-data">
                                      <div class="col">
                                          <p><b>Jenis Biji Kopi: </b>' . $data[0]->biji_kopi . '</p>
                                          <p><b>Jenis Penyajian: </b>' . $data[0]->penyajian . '</p>
                                          <p><b>Teknik Penyeduhan: </b>' . $data[0]->penyeduhan_kopi . '</p>
                                          <p><b>Takaran Kopi: </b>' . $data[0]->kopi . 'ml</p>
                                          <div class="judul-data">
                                              <p  class="judul"><b>Takaran Gula</b></p>
                                              <div class="detail-data">
                                                  <p><b>Less Sugar: </b>' . $data[0]->less_sugar . 'ml</p>
                                                  <p><b>Normal Sugar: </b>' . $data[0]->normal_sugar . 'ml</p>
                                                  <p><b>Extra Sugar: </b>' . $data[0]->extra_sugar . 'ml</p>
                                              </div>
                                          </div>               
                                      </div>
                                      <div class="col">
                                          <div class="judul-data">
                                              <p class="judul"><b>Bahan Tambahan: </b></p>
                                              <div class="detail-data">
                                                  <p><b>Cokelat: </b>' . $data[0]->bahan_tambahan->cokelat . 'gram</p>
                                                  <p><b>Matcha: </b>' . $data[0]->bahan_tambahan->matcha . 'gram</p>
                                                  <p><b>Ice Cream: </b>' . $data[0]->bahan_tambahan->ice_cream . 'cup</p>
                                              </div>
                                          </div>
                                          <p><b>Jumlah Kafein: </b>' . $data[0]->kafein . 'mg</p>
                                          <div class="judul-data">
                                              <p class="judul"><b>Jumlah Glukosa: </b></p>
                                              <div class="detail-data">
                                                  <p><b>Less Sugar: </b>' . $data[0]->less_glukosa . 'gram</p>
                                                  <p><b>Normal Sugar: </b>' . $data[0]->normal_glukosa . 'gram</p>
                                                  <p><b>Extra Sugar: </b>' . $data[0]->extra_glukosa . 'gram</p>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="data">
                                  <h4>Deskripsi Kopi</h4>
                                  <p>' . $data[0]->deskripsi . '</p>
                              </div>
                          </div>
                            <div class="button-menu">
                                <a href="editKopi.php?id=' . $id_kopi . '" class="button-edit">
                                    <i class="fa-solid fa-pen"></i>
                                    <p>Edit</p>
                                </a>
                                <a href="hapusKopi.php?id=' . $id_kopi . '" class="button-delete">
