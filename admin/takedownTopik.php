...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/takedownTopik.css">
    <!-- Library AOS -->
            ...
            <div class="card-laporan">
                <div class="content-card">
                    ...
                    <div class="content-laporan">
                        ...
                        $options = array(
                            CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-yuxyg/endpoint/getAllReportTopikByIdTopik?id_topik=' . $id_topik,
                            CURLOPT_CUSTOMREQUEST => 'GET',
                            CURLOPT_RETURNTRANSFER => true
                        );
                        ...
                        $topik = getTopikById($reportTopik[0]->id_topik);
                        $jumlah_balasan = getJumlahBalasan($reportTopik[0]->id_topik);
                        $konsumen = getKonsumenById($topik[0]->id_pengirim);
                        ?>
                        <div class="topic">
                            <div class="profil">
                                <img src="assets/<?php echo $konsumen[0]->profile_picture ?>" alt="" class="profile-topic">
                                <div class="akun">
                            ...
                            <div class="teks-topic">
                                <h4><?php echo $topik[0]->pesanTopik ?></h4>
                                <div class="bot-topic">
                                    <p><?php echo $jumlah_balasan; ?> Balasan</p>
                                    <p><?php echo $topik[0]->waktu; ?> WIB</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="button-laporan">
                            <a href="topikAman.php?id_topik=<?php echo $id_topik; ?>" class="button-aman">
                                <p>Aman</p>
                            </a>
                            <a href="deleteTopik.php?id=<?php echo $id_topik; ?>" class="button-takedown">
                                <p>Takedown</p>
                            </a>
                        </div>
                    </div>
