...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/dataCaffenchat.css">
    <!-- Library AOS -->
        ...
        <div class="container" data-aos="zoom-in-up">
            <div class="card-user">
                <div class="content-card">
                    <div class="header">
                        <a href="profilUser.php?id=<?php echo $id_konsumen; ?>">
                            <i class="fa-solid fa-arrow-left"></i>
                        </a>
                        <h1>Data Caffe-nChat</h1>
                    </div>
                    <div class="data-caffenchat">
                        <div class="profil">
                            ...
                            $konsumen = getKonsumenById($id_konsumen);
                            ?>

                            <img src="assets/<?php echo $konsumen[0]->profile_picture; ?>" alt="" class="profile-picture-header">
                            <div class="teks">
                                <h2><?php echo $konsumen[0]->nama; ?></h2>
                                <h3><?php echo $konsumen[0]->username; ?></h3>
                            </div>
                        </div>
                        <h2 class="judul">RIWAYAT POSTING</h2>
                        <div class="content-history">
                            ...
                            <div id="Topik" class="tabcontent">
                                ...
                                $options = array(
                                    CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-yuxyg/endpoint/getAllTopikByIdPengirim?id_pengirim=' . $id_konsumen,
                                    CURLOPT_CUSTOMREQUEST => 'GET',
                                    CURLOPT_RETURNTRANSFER => true
                                );
