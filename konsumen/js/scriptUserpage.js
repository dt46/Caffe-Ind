...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const rekomendasiButton = document.querySelector("#rekomendasi-button");
    ...
    rekomendasiButton.addEventListener("click", function (e) {
        e.preventDefault();
        
        // Lakukan scroll otomatis ke elemen div input
        rekomendasiSection.scrollIntoView({ behavior: "smooth" });
    });
});
